...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    <?php
    if ($column_left && $column_right) $class = 'col-sm-6';
    elseif ($column_left || $column_right) $class = 'col-sm-9';
    else $class = 'col-sm-12'; ?>
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="row">
        <?php 
        if ($column_left && $column_right) $class = 'col-sm-7';
        elseif ($column_left || $column_right) $class = 'col-sm-7';
        else $class = 'col-sm-8';
        ?>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-files">
             ...
             <?php foreach ($files as $file) { ?>
               <li><a href="<?php echo ITEMS_URL.$file['link']; ?>" class="fileico-<?php echo substr($file, strrpos($file['link'], ".")+1); ?>"><?php echo $file['title']; ?></a></li>
            <?php } ?>
             </ul>	
             </div>
            <?php } ?>
            ...
            <div class="tab-pane" id="tab-review">
              <form class="form-horizontal">
                ...
                <div class="form-group required">
                  <label class="col-sm-4 control-label" for="input-review"><?php echo $entry_review; ?></label>
                  <div class="col-sm-8">
                ...
                <div class="form-group required">
                  <label class="col-sm-4 control-label"><?php echo $entry_rating; ?></label>
                  <div class="col-sm-8"><?php echo $entry_bad; ?>&nbsp;
                ...
                <div class="form-group required">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="captcha" value="" id="input-captcha" class="form-control" /><br />
        ...
        <?php if ($column_left && $column_right) $class = 'col-sm-5';
        elseif ($column_left || $column_right) $class = 'col-sm-5';
        else $class = 'col-sm-4'; ?>
        <div class="<?php echo $class; ?>">
          <div class="btn-group">
          ...
          <ul class="list-unstyled">
            ...
            <li><?php echo $text_qty; ?> <?php echo $qty; ?></li>
            <?php if($qpbox > 1) { ?>
            <li><?php echo $text_in_pack . ' ' . $qpbox; ?></li>
						<li><?php echo $text_unit_price . ' <b>' . $unit_price . '</b>'; ?></li>
						<?php } ?>
          </ul>
          <?php if ($price) { ?>
          <ul class="list-unstyled">
            <li class="price">
              <?php if ($special <= 0) { echo $price; } else { ?>
          ...
          <?php
          if($stocks && false){ ?>
					 <select name='price' size='7' multiple class="form-control">	
						<?php foreach($stocks as $stock)
						{
							echo '<option value="'.$stock['stock_id'].'"> '.$stock['stock_name'].' - '. $stock['term']. ' - '. $text_qty.' '.$stock['quantity'].' - '.$text_price.' ' .$stock['price'].'</option>';	
						} ?>
					 </select>
					<?php } ?>
          <div id="product">
