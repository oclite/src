...
$(window).load(function() {
	$('#accordion li.level0  ul').each(function(index) {$(this).prev().addClass('idCatSubcat')});
	...
	$('#accordion li.level0.active > ul  li.active > ul li.active > ul').css('display','block');
	$('#accordion li.level0 ul').each(function(index) {
