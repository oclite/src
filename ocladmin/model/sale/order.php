...
class ModelSaleOrder extends Model {
	public function addOrder($data) {
		...
		// Update order total			 
		$this->db->query("UPDATE `" . DB_PREFIX . "order` SET total = '" . (float)$total . "', commission = '" . (float)$commission . "' WHERE order_id = '" . (int)$order_id . "'"); 	
	}
	...
	public function editOrder($order_id, $data) {
		...
		if ($zone_info) $shipping_zone = $zone_info['name'];
		else $shipping_zone = '';
	...
	public function getTotalOrdersByStore() {
