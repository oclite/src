...
<div id="content">
  ...
  <div class="panel panel-default">
	...
	<ul class="breadcrumb">
    <?php foreach ($breadcrumbs2 as $breadcrumb) { ?>
    <li><a href="<?php echo $breadcrumb['href']; ?>"><?php echo $breadcrumb['text']; ?></a></li>
    <?php } ?>
  </ul>
            ...
            <tbody>
              ...
              <tr>
                <td class="text-center"><?php if (in_array($category['category_id'], $selected)) { ?>
                  ...
                  <?php } ?></td>
                <td class="text-left"><a href="<?php echo $category['link']; ?>"><?php echo $category['name']; ?></a></td>
                <td class="text-right"><?php echo $category['sort_order']; ?></td>
                <td class="text-right"><a href="<?php echo $category['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-warning"><i class="fa fa-pencil-square-o"></i></a></td>
              </tr>
              <?php } ?>
              <?php } else { ?>
              <tr>
