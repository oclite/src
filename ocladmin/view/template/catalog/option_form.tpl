          ...
          <tbody>
            ...
            <tr id="option-value-row<?php echo $option_value_row; ?>">
              <td class="text-left"><input type="hidden" name="option_value[<?php echo $option_value_row; ?>][option_value_id]" value="<?php echo $option_value['option_value_id']; ?>" />
                <div class="input-group">
                  <input type="text" name="option_value[<?php echo $option_value_row; ?>][name]" value="<?php echo isset($option_value['name']) ? $option_value['name'] : ''; ?>" placeholder="<?php echo $entry_option_value; ?>" class="form-control" />
                </div>
                <?php if (isset($error_option_value[$option_value_row])) { ?>
                <div class="text-danger"><?php echo $error_option_value[$option_value_row]; ?></div>
                <?php } ?>
                </td>
...
function addOptionValue() {
	...
	html += '<input type="text" name="option_value[' + option_value_row + '][name]" value="" placeholder="<?php echo $entry_option_value; ?>" class="form-control" />    </div>  </td>';
