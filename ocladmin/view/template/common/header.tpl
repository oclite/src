  ...
  <div class="container-fluid">
    ...
    <ul class="nav pull-right">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-cog fa-lg"></i></a>
        <ul class="dropdown-menu dropdown-menu-right">
          <li class="dropdown-header"><a href="/" target="_blank"><?php echo $text_front; ?> <i class="fa fa-shopping-cart"></i></a></li>
          <li class="divider"></li>
          <li><a href="http://www.oclite.ru/" target="_blank"><i class="fa fa-globe"></i> <?php echo $text_homepage; ?></a></li>
          <li><a href="http://docs.oclite.ru" target="_blank"><i class="fa fa-info-circle"></i> <?php echo $text_documentation; ?></a></li>
          <li><a href="http://forum.oclite.ru" target="_blank"><i class="fa fa-users"></i> <?php echo $text_support; ?></a></li>
        </ul>
      </li>
      <li class="dropdown">
        <?php if ($image) { ?>
        ...
        <ul class="dropdown-menu dropdown-menu-right">
          ...
          <li><a href="<?php echo $setting; ?>"><i class="fa fa-tasks"></i> <?php echo $text_setting; ?></a></li>
