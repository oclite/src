        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <select name="cod_geo_zone_id" id="input-geo-zone" class="form-control">
              <option value="0"<?php if($cod_geo_zone_id == 0) echo ' selected="selected"'; ?>><?php echo $text_all_zones; ?></option>
              <option value="<?php echo $geo_zones['zone_id']; ?>"<?php if ($geo_zones['zone_id'] == $cod_geo_zone_id)  echo ' selected="selected"'; ?>><?php echo $geo_zones['name']; ?></option>
            </select>
          </div>
        </div>
        <div class="form-group">
