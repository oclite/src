            ...
            <tr id="image-row<?php echo $image_row; ?>">
              <td class="text-left">
                <div class="input-group pull-left">
                  <input type="text" name="banner_image[<?php echo $image_row; ?>][title]" value="<?php echo isset($banner_image['title']) ? $banner_image['title'] : ''; ?>" placeholder="<?php echo $entry_title; ?>" class="form-control" />
                </div>
                <?php if (isset($error_banner_image[$image_row])) { ?>
                <div class="text-danger"><?php echo $error_banner_image[$image_row]; ?></div>
                <?php } ?></td>
