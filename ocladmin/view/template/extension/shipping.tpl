        ...
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-left"><a href="<?php echo $extension['status_toggle']; ?>" data-toggle="tooltip" title="<?php echo $extension['status_text']; ?>" class="btn btn-<?php echo ($extension['status'] === 'off')? 'danger' : 'success'; ?>"<?php if(!$extension['installed']) echo ' disabled="disabled"'; ?>><i class="fa fa-toggle-<?php echo $extension['status']; ?>"></i></a></td>
