    ...
    <div class="panel-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-weight" class="form-horizontal">
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="weight_descr" value="<?php echo $weight_descr; ?>" placeholder="<?php echo $entry_descr; ?>" id="input-descr" class="form-control" />
          </div>
        </div>
		<div class="form-group">
		...
		<div class="form-group">
          ...
          <div class="col-sm-10">
            <select name="weight_geo_zone_id" id="input-geo-zone" class="form-control">
              <option value="0"<?php if($weight_geo_zone_id == 0) echo ' selected="selected"'; ?>><?php echo $text_all_zones; ?></option>
              <option value="<?php echo $geo_zones['zone_id']; ?>"<?php if ($geo_zones['zone_id'] == $weight_geo_zone_id)  echo ' selected="selected"'; ?>><?php echo $geo_zones['name']; ?></option>
            </select>
          </div>
        </div>
      </form>
