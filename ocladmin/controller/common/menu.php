...
class ControllerCommonMenu extends Controller {
	public function index() {	
		...
		$data['text_stocks'] = $this->language->get('text_stocks');
		...
		if (!isset($this->request->get['token']) || !isset($this->session->data['token']) && ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$data['stocks'] = $this->url->link('catalog/stocks', 'token=' . $this->session->data['token'], 'SSL');
			...
			$data['update'] = $this->url->link('tool/update', 'token=' . $this->session->data['token'], 'SSL');
