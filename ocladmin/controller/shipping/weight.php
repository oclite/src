...
class ControllerShippingWeight extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['weight_descr'])) {
			$data['weight_descr'] = $this->request->post['weight_descr'];
		} else {
			$data['weight_descr'] = $this->config->get('weight_descr');
		}
		if (isset($this->request->post['weight_geo_zone_id'])) {
			$data['weight_geo_zone_id'] = $this->request->post['weight_geo_zone_id'];
		} else {
			$data['weight_geo_zone_id'] = $this->config->get('weight_geo_zone_id');
		}
