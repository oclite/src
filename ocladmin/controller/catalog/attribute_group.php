...
class ControllerCatalogAttributeGroup extends Controller { 
	...
	protected function getList() {
		...
		$data['sort_name'] = $this->url->link('catalog/attribute_group', 'token=' . $this->session->data['token'] . '&sort=name' . $url, 'SSL');
		$data['sort_sort_order'] = $this->url->link('catalog/attribute_group', 'token=' . $this->session->data['token'] . '&sort=sort_order' . $url, 'SSL');
	...
	protected function getForm() {
		...
		if (isset($this->request->post['name'])) {
			...
			$data['name'] = $attribute_group_info['name'];
		} else $data['name'] = '';
