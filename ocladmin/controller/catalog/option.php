...
class ControllerCatalogOption extends Controller {
	...
	protected function getList() {
		...
		$data['sort_name'] = $this->url->link('catalog/option', 'token=' . $this->session->data['token'] . '&sort=name' . $url, 'SSL');
		$data['sort_sort_order'] = $this->url->link('catalog/option', 'token=' . $this->session->data['token'] . '&sort=sort_order' . $url, 'SSL');
	...
	protected function getForm() {
		...
		$data['error_option_value'] = (isset($this->error['option_value']))? $this->error['option_value'] : array();	
		...
		foreach ($option_values as $option_value) {
			$image = (is_file(DIR_CONTENT . $option_value['image']))? $option_value['image'] : '';
			$data['option_values'][] = array(
		...
		if (isset($this->request->get['filter_name'])) {
			...
			foreach ($options as $option) {
				...
				if ($option['type'] == 'select' || $option['type'] == 'radio' || $option['type'] == 'checkbox' || $option['type'] == 'image') {
					...
					foreach ($option_values as $option_value) {
						$image = (is_file(DIR_CONTENT . $option_value['image']))? $this->model_tool_image->resize($option_value['image'], 50, 50) : '';
