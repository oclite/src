...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_contact_text'] = $this->language->get('entry_contact_text');
		...
		$data['entry_checkout_minimum'] = $this->language->get('entry_checkout_minimum');
		...
		$data['entry_custom_header'] = $this->language->get('entry_custom_header');
		$data['entry_custom_footer'] = $this->language->get('entry_custom_footer');
		$data['entry_map'] = $this->language->get('entry_map');
		$data['help_admin_email'] = $this->language->get('help_admin_email');
		$data['help_shop_email'] = $this->language->get('help_shop_email');
		$data['help_map'] = $this->language->get('help_map');
		$data['help_custom_footer'] = $this->language->get('help_custom_footer');
		$data['help_custom_header'] = $this->language->get('help_custom_header');
		$data['help_geocode'] = $this->language->get('help_geocode');
		$data['help_open'] = $this->language->get('help_open');
		$data['help_contacts'] = $this->language->get('help_contacts');
		$data['help_contact_text'] = $this->language->get('help_contact_text');
		$data['help_details'] = $this->language->get('help_details');
		...
		$data['help_checkout_minimum'] = $this->language->get('help_checkout_minimum');
		...
		} else $data['error_owner'] = '';
		if (isset($this->error['address_1'])) {
			$data['error_address'] = $this->error['address'];
		} else $data['error_address'] = '';
		if (isset($this->error['shop_email'])) {
			$data['error_shop_email'] = $this->error['shop_email'];
		} else $data['error_shop_email'] = '';
		if (isset($this->error['admin_email'])) {
			$data['error_admin_email'] = $this->error['admin_email'];
		} else $data['error_admin_email'] = '';
		if (isset($this->error['telephone'])) {
			$data['error_telephone'] = $this->error['telephone'];
		} else $data['error_telephone'] = '';
		if (isset($this->error['contacts'])) {
			$data['error_contacts'] = $this->error['contacts'];
		} else $data['error_contacts'] = '';
		if (isset($this->error['meta_title'])) {
			$data['error_meta_title'] = $this->error['meta_title'];
		} else $data['error_meta_title'] = '';
		if (isset($this->error['country'])) {
			$data['error_country'] = $this->error['country'];
		} else $data['error_country'] = '';
		if (isset($this->error['zone'])) {
			$data['error_zone'] = $this->error['zone'];
		} else $data['error_zone'] = '';
		if (isset($this->error['customer_group_display'])) {
			$data['error_customer_group_display'] = $this->error['customer_group_display'];
		} else $data['error_customer_group_display'] = '';
		if (isset($this->error['voucher_min'])) {
			$data['error_voucher_min'] = $this->error['voucher_min'];
		} else $data['error_voucher_min'] = '';
		if (isset($this->error['voucher_max'])) {
			$data['error_voucher_max'] = $this->error['voucher_max'];
		} else $data['error_voucher_max'] = '';
		if (isset($this->error['image_category'])) {
			$data['error_image_category'] = $this->error['image_category'];
		} else $data['error_image_category'] = '';
		if (isset($this->error['image_thumb'])) {
			$data['error_image_thumb'] = $this->error['image_thumb'];
		} else $data['error_image_thumb'] = '';
		if (isset($this->error['image_popup'])) {
			$data['error_image_popup'] = $this->error['image_popup'];
		} else $data['error_image_popup'] = '';
		if (isset($this->error['image_product'])) {
			$data['error_image_product'] = $this->error['image_product'];
		} else $data['error_image_product'] = '';
		if (isset($this->error['image_additional'])) {
			$data['error_image_additional'] = $this->error['image_additional'];
		} else $data['error_image_additional'] = '';
		if (isset($this->error['image_related'])) {
			$data['error_image_related'] = $this->error['image_related'];
		} else $data['error_image_related'] = '';
		if (isset($this->error['image_compare'])) {
			$data['error_image_compare'] = $this->error['image_compare'];
		} else $data['error_image_compare'] = '';
		if (isset($this->error['image_wishlist'])) {
			$data['error_image_wishlist'] = $this->error['image_wishlist'];
		} else $data['error_image_wishlist'] = '';
		if (isset($this->error['image_cart'])) {
			$data['error_image_cart'] = $this->error['image_cart'];
		} else $data['error_image_cart'] = '';
		if (isset($this->error['image_manufacturer'])) {
			$data['error_image_manufacturer'] = $this->error['image_manufacturer'];
		} else $data['error_image_manufacturer'] = '';
		if (isset($this->error['error_filename'])) {
			$data['error_error_filename'] = $this->error['error_filename'];
		} else $data['error_error_filename'] = '';
		if (isset($this->error['product_limit'])) {
			$data['error_product_limit'] = $this->error['product_limit'];
		} else $data['error_product_limit'] = '';
		if (isset($this->error['product_description_length'])) {
			$data['error_product_description_length'] = $this->error['product_description_length'];
		} else $data['error_product_description_length'] = '';
		if (isset($this->error['limit_admin'])) {
			$data['error_limit_admin'] = $this->error['limit_admin'];
		} else $data['error_limit_admin'] = '';
		if (isset($this->error['encryption'])) {
			$data['error_encryption'] = $this->error['encryption'];
		} else $data['error_encryption'] = '';
		...
		} else $data['config_name'] = $this->config->get('config_name');
		if (isset($this->request->post['config_owner'])) {
			$data['config_owner'] = $this->request->post['config_owner'];
		} else $data['config_owner'] = $this->config->get('config_owner');
		if (isset($this->request->post['config_address_1'])) {
			$data['config_address'] = $this->request->post['config_address'];
		} else $data['config_address'] = $this->config->get('config_address');
		if (isset($this->request->post['config_geocode'])) {
			$data['config_geocode'] = $this->request->post['config_geocode'];
		} else $data['config_geocode'] = $this->config->get('config_geocode');
		if (isset($this->request->post['config_shop_email'])) {
			$data['config_shop_email'] = $this->request->post['config_shop_email'];
		} else $data['config_shop_email'] = $this->config->get('config_shop_email');
		if (isset($this->request->post['config_admin_email'])) {
			$data['config_admin_email'] = $this->request->post['config_admin_email'];
		} else $data['config_admin_email'] = $this->config->get('config_admin_email');
		if (isset($this->request->post['config_contacts'])) {
			$data['config_contacts'] = $this->request->post['config_contacts'];
		} else $data['config_contacts'] = $this->config->get('config_contacts');
		if (isset($this->request->post['config_telephone'])) {
			$data['config_telephone'] = $this->request->post['config_telephone'];
		} else $data['config_telephone'] = $this->config->get('config_telephone');
		if (isset($this->request->post['config_contact_text'])) {
			$data['config_contact_text'] = $this->request->post['config_contact_text'];
		} else $data['config_contact_text'] = $this->config->get('config_contact_text');
		if (isset($this->request->post['config_image'])) {
			$data['config_image'] = $this->request->post['config_image'];
		} else $data['config_image'] = $this->config->get('config_image');
		$this->load->model('tool/image');
		if (isset($this->request->post['config_image']) && is_file(DIR_CONTENT . $this->request->post['config_image'])) {
			$data['thumb'] = $this->request->post['config_image'];
		} elseif ($this->config->get('config_image') && is_file(DIR_CONTENT . $this->config->get('config_image'))) {
		...
		} else $data['config_open'] = $this->config->get('config_open');
		if (isset($this->request->post['config_details'])) {
			$data['config_details'] = $this->request->post['config_details'];
		} else $data['config_details'] = $this->config->get('config_details');
		if (isset($this->request->post['config_meta_title'])) {
			$data['config_meta_title'] = $this->request->post['config_meta_title'];
		} else $data['config_meta_title'] = $this->config->get('config_meta_title');
		if (isset($this->request->post['config_meta_description'])) {
			$data['config_meta_description'] = $this->request->post['config_meta_description'];
		} else $data['config_meta_description'] = $this->config->get('config_meta_description');
		if (isset($this->request->post['config_layout_id'])) {
			$data['config_layout_id'] = $this->request->post['config_layout_id'];
		} else $data['config_layout_id'] = $this->config->get('config_layout_id');
		$this->load->model('design/layout');
		$data['layouts'] = $this->model_design_layout->getLayouts();
		if (isset($this->request->post['config_template'])) {
			$data['config_template'] = $this->request->post['config_template'];
		} else $data['config_template'] = $this->config->get('config_template');
		...
		} else $data['config_country_id'] = $this->config->get('config_country_id');
		$this->load->model('localisation/country');
		$data['countries'] = $this->model_localisation_country->getCountries();
		if (isset($this->request->post['config_zone_id'])) {
			$data['config_zone_id'] = $this->request->post['config_zone_id'];
		} else $data['config_zone_id'] = $this->config->get('config_zone_id');
		...
		} else $data['config_length_class_id'] = $this->config->get('config_length_class_id');
		...
		} else $data['config_weight_class_id'] = $this->config->get('config_weight_class_id');
		...
		} else $data['config_voucher_max'] = $this->config->get('config_voucher_max');
		if (isset($this->request->post['config_customer_online'])) {
			$data['config_customer_online'] = $this->request->post['config_customer_online'];
		} else $data['config_customer_online'] = $this->config->get('config_customer_online');
		...
		} else $data['config_account_mail'] = $this->config->get('config_account_mail');
		if (isset($this->request->post['config_cart_weight'])) {
			$data['config_cart_weight'] = $this->request->post['config_cart_weight'];
		} else $data['config_cart_weight'] = $this->config->get('config_cart_weight');
		if (isset($this->request->post['config_checkout_guest'])) {
			$data['config_checkout_guest'] = $this->request->post['config_checkout_guest'];
		} else $data['config_checkout_guest'] = $this->config->get('config_checkout_guest');
		if (isset($this->request->post['config_checkout_id'])) {
			$data['config_checkout_id'] = $this->request->post['config_checkout_id'];
		} else $data['config_checkout_id'] = $this->config->get('config_checkout_id');
		...
		} else $data['config_invoice_prefix'] = 'INV-' . date('Y') . '-00';
		if (isset($this->request->post['config_checkout_minimum'])) {
			$data['config_checkout_minimum'] = 1 * $this->request->post['config_checkout_minimum'];
		} elseif ($this->config->get('config_checkout_minimum')) {
			$data['config_checkout_minimum'] = $this->config->get('config_checkout_minimum');
		} else $data['config_checkout_minimum'] = 0;
		if (isset($this->request->post['config_order_status_id'])) {
			$data['config_order_status_id'] = $this->request->post['config_order_status_id'];
		} else $data['config_order_status_id'] = $this->config->get('config_order_status_id');
		...
		} else $data['config_complete_status_id'] = $this->config->get('config_complete_status_id');
		...
		} else $data['config_stock_display'] = $this->config->get('config_stock_display');
		if (isset($this->request->post['config_stock_warning'])) {
			$data['config_stock_warning'] = $this->request->post['config_stock_warning'];
		} else $data['config_stock_warning'] = $this->config->get('config_stock_warning');
		...
		} else $data['config_logo'] = $this->config->get('config_logo');
		if (isset($this->request->post['config_logo']) && is_file(DIR_CONTENT . $this->request->post['config_logo'])) {
			$data['logo'] = $this->model_tool_image->resize($this->request->post['config_logo'], 100, 100);
		} elseif ($this->config->get('config_logo') && is_file(DIR_CONTENT . $this->config->get('config_logo'))) {
			$data['logo'] = $this->model_tool_image->resize($this->config->get('config_logo'), 100, 100);
		} else $data['logo'] = '';
		if (isset($this->request->post['config_icon'])) {
			$data['config_icon'] = $this->request->post['config_icon'];
		} else $data['config_icon'] = $this->config->get('config_icon');
		if (isset($this->request->post['config_icon']) && is_file(DIR_CONTENT . $this->request->post['config_icon'])) {
			$data['icon'] = $this->model_tool_image->resize($this->request->post['config_icon'], 16, 16);
		} elseif ($this->config->get('config_icon') && is_file(DIR_CONTENT . $this->config->get('config_icon'))) {
		...
		} else $data['config_seo_url'] = $this->config->get('config_seo_url');
		...
		} else $data['config_maintenance'] = $this->config->get('config_maintenance');
		if (isset($this->request->post['config_password'])) {
			$data['config_password'] = $this->request->post['config_password'];
		} else $data['config_password'] = $this->config->get('config_password');
		if (isset($this->request->post['config_encryption'])) {
			$data['config_encryption'] = $this->request->post['config_encryption'];
		} else $data['config_encryption'] = $this->config->get('config_encryption');
		if (isset($this->request->post['config_compression'])) {
			$data['config_compression'] = $this->request->post['config_compression'];
		} else $data['config_compression'] = $this->config->get('config_compression');
		...
		if (isset($this->request->post['config_custom_header'])) {
			$data['config_custom_header'] = $this->request->post['config_custom_header'];
		} elseif(is_file(DIR_CONTENT . 'data/header.html')) {
			$data['config_custom_header'] = file_get_contents(DIR_CONTENT . 'data/header.html');
		}
		else $data['config_custom_header'] = '';
		if (isset($this->request->post['config_custom_footer'])) {
			$data['config_custom_footer'] = $this->request->post['config_custom_footer'];
		} elseif(is_file(DIR_CONTENT . 'data/footer.html')) {
			$data['config_custom_footer'] = file_get_contents(DIR_CONTENT . 'data/footer.html');
		}
		else $data['config_custom_footer'] = '';
		if (isset($this->request->post['config_map'])) {
			$data['config_map'] = $this->request->post['config_map'];
		} else $data['config_map'] = $this->config->get('config_map');
	...
	protected function validate() {
		...
		if ((utf8_strlen($this->request->post['config_admin_email']) > 96) || !preg_match('/^[^\@]+@.*\.[a-z]{2,6}$/i', $this->request->post['config_admin_email'])) {
			$this->error['admin_email'] = $this->language->get('error_email');
		}
		if ((utf8_strlen($this->request->post['config_shop_email']) > 96) || !preg_match('/^[^\@]+@.*\.[a-z]{2,6}$/i', $this->request->post['config_shop_email'])) {
			$this->error['shop_email'] = $this->language->get('error_email');
		}
		if ((utf8_strlen($this->request->post['config_telephone']) < 3) || (utf8_strlen($this->request->post['config_telephone']) > 32)) {
			$this->error['telephone'] = $this->language->get('error_telephone');
		}
		if (utf8_strlen($this->request->post['config_contacts']) > 3) {
			$this->request->post['config_contacts'] = str_replace(array("\r","\n","\t"),'',$this->request->post['config_contacts']);
		}
	...
	public function template() {
		...
		if (is_file(DIR_CONTENT . 'templates/' . basename($this->request->get['template']) . '.png')) {
			$this->response->setOutput($server . 'content/templates/' . basename($this->request->get['template']) . '.png');
		} else {
			$this->response->setOutput($server . 'content/no_image.jpg');
		}
	}
